        ...
        <form onSubmit={this.handleSubmit} style={pixStyle}>
          <FormGroup controlId='formControlsSelect'>
            ...
            >
              ...
              <option value='arianna%%Arianna Henry%%Digital Ads Specialist &amp; Project Coordinator'>
                Arianna Henry
              </option>
              <option value='katie%%Katie Moore%%Bookkeeper'>
                Katie Moore
              </option>
              ...
              <option value='randall%%Randall Stewart%%Client Success Manager'>
                Randall Stewart
              </option>
