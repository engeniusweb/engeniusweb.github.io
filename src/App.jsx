          ...
          {!loading && user && (
              <div>
                <div className='flex items-center p-2 border-b'>
                  ...
                  <div className='grow'/>
                  <button className='text-secondary hover:text-secondary-200 transition-colors'
                ...
                <div className='flex justify-end border-t p-2'>
                  <button className='px-2 py-1 rounded text-white bg-secondary hover:bg-secondary-200 transition-colors'
